...
stock_name = 'NTB2'
column_name1 = "Open Price"
column_name2 = "Close Price"
...
df[column_name1] = df['Open (Rs.)']
df[column_name2] = df['Close (Rs.)']

# Create a new DataFrame with 'Trade Date' and 'Price Change' columns
new_df = df[['Date', column_name1, column_name2]]

# Write the new DataFrame to a CSV file
new_df.to_csv('processed_stock_files/'+stock_name+'_open_close.csv', index=False)
